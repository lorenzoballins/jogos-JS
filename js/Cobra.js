...
let gameActive = true; // Adicione uma variável para rastrear o estado do jogo

const moveSnake = () => {
    if (!direction || !gameActive) return; // Verifique se o jogo está ativo
...
const gameOver = () => {
    direction = undefined
    gameActive = false; // Define o estado do jogo como inativo
